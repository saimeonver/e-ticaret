...
namespace And.Eticaret.UI.WEB.Areas.Admin.Controllers
{
    public class AdminOrdersController : Controller
    {
        ...
        {
            var order = db.Order.Include(o => o.Status).Include(o => o.User).Include(o => o.UserAddress);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.UserAddressID = new SelectList(db.UserAdresses, "ID", "Title");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,UserAddressID,StatusID,TotalProductPrice,TotalTaxPrice,TotalDiscount,TotalPrice,CreateDate,CreateUserID,UpdateDate,UpdateUserID")] Order order)
        {
            ...
            ViewBag.UserAddressID = new SelectList(db.UserAdresses, "ID", "Title", order.UserAddressID);
            return View(order);
        }
